var sqlMap = {
    ...
    insertPatientOrderPage: 'INSERT INTO ??(name,name_pinyin,sex,age,phone) VALUES(?,?,?,?,?)',
    updatePatientOrderPage: 'UPDATE ?? SET sex = ?, age = ?, phone = ? WHERE id = ?',
    updatePatientTimes: 'UPDATE ?? SET visitTimes = visitTimes + ? WHERE id = ?',
    ...
    updateUserSetting: 'UPDATE myDbs_userconfig SET displayYaowan = ?, displayProfit = ?, displayLessMenu = ?, defaultDoctor = ? WHERE userid = ?',
