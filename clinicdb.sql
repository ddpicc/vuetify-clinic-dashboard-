...
insert into `test_medlist`(`medname`,`alias`,`medtype`,`inventoryNm`,`baseprice`,`sellprice`,`checked`) values ('白芍','bs','免煎',0,3,38,0), ('熟地','sd','免煎',5,0.39,0.8,1), ('炒山楂','csz','草药',0,0.016,0.05,0) ;
